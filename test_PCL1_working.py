...
from test_ast import inverser_enfants_arbre
...
class MyTestCase(unittest.TestCase):
    ...
    def test_ast(self):
        ...
        arbre = inverser_enfants_arbre(construire_arbre(parse_res))

        show.visualize_tree(arbre).render(filename='syntax_tree', directory='./output', cleanup=True, format='png',
                                          engine='dot')
        show.visualize_tree_hor(arbre, orientation='LR').render(filename='syntax_tree_hor', directory='./output',
